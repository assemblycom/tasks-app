...
> => {
  ...
  return {
    [TaskReminderType.NO_DUE_DATE_3D]: {
      ...
      header,
      title,
      body: `This is a friendly reminder that you have a task ‘${task.title}’ assigned to you that's still pending completion.<br><br>If you've already completed this task, please mark it as done in the portal.`,
      ctaParams,
    },
    [TaskReminderType.NO_DUE_DATE_7D]: {
      ...
      header,
      title,
      body: `This is a friendly reminder that you have a task ‘${task.title}’ that was assigned to you a week ago and is still pending.<br><br>If you've already completed this task, please mark it as done in the portal.`,
      ctaParams,
    },
    [TaskReminderType.DUE_DATE_BEFORE_3D]: {
      ...
      header,
      title,
      body: `This is a friendly reminder that you have a task ‘${task.title}’ due in 3 days.<br><br>Please make sure to complete this task by the due date.`,
      ctaParams,
    },
    [TaskReminderType.DUE_DATE_TODAY]: {
      ...
      header,
      title,
      body: `This is a friendly reminder that you have a task ‘${task.title}’ due today.<br><br>Please complete this task as soon as possible.`,
      ctaParams,
    },
    ...
    [TaskReminderType.DUE_DATE_OVERDUE_7D]: {
      ...
      header,
      title,
      body: `This is a friendly reminder that the task ‘${task.title}’ is now one week overdue.<br><br>Please complete this task as soon as possible.`,
      ctaParams,
    },
  }
}
